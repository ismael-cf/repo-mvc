...
<head>
    ...
    <style>
        ...
        button {
            background: #28a745; /* Verde para guardar */
            margin-bottom: 15px;
        }
...
<div class="form-container">
    ...
    <form action="<?php echo RUTA_APP; ?>productos/guardar/<?php echo $data['id']; ?>" method="POST">
        ...
        <input type="text" name="marca" value="<?php echo $data['marca']; ?>" required>

        <!-- Talla -->
        <label for="talla">Talla:</label>
        <input type="text" name="talla" value="<?php echo $data['talla']; ?>">

        <!-- Color -->
        <label for="color">Color:</label>
        <input type="text" name="color" value="<?php echo $data['color']; ?>" required>

        <!-- Precio -->
        <label for="precio">Precio:</label>
        <input type="text" name="precio" value="<?php echo $data['precio']; ?>" required>
